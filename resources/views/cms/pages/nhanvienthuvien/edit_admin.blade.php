            ...
            <form class="form-horizontal form-label-left" novalidate action="" method="post" enctype="multipart/form-data">
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input class="form-control col-md-7 col-xs-12" name="manhanvien" required="required" type="text" value="{{old('manhanvien',isset($nhanvien)) ? $nhanvien['manhanvien'] : null }}">
                  <div style="color: red">
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input class="form-control col-md-7 col-xs-12" name="username" required="required" type="text" value="{{old('username',isset($nhanvien)) ? $nhanvien['username'] : null }}">
                  <div style="color: red">
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" name="hoten" required="required" class="form-control col-md-7 col-xs-12" value="{{old('hoten',isset($nhanvien)) ? $nhanvien['hoten'] : null }}">
                  <div style="color: red">
                    @if($errors->has('hoten'))
                       {{ $errors->first('hoten')}}
                    @endif
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="date" name="ngaysinh" required="required" class="form-control col-md-7 col-xs-12" value="{{old('ngaysinh',isset($nhanvien)) ? $nhanvien['ngaysinh'] : null }}">
                </div>
              </div>
              <div class="item form-group">
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" name="email" required="required" class="form-control col-md-7 col-xs-12" value="{{old('email',isset($nhanvien)) ? $nhanvien['email'] : null }}">
                </div>
              </div>
              <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="occupation">Điện thoại </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" name="dienthoai" required="required" class="form-control col-md-7 col-xs-12" value="{{old('dienthoai',isset($nhanvien)) ? $nhanvien['dienthoai'] : null }}">
                </div>
              </div>
              <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="occupation">Địa chỉ </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" name="diachi" required="required" class="form-control col-md-7 col-xs-12" value="{{old('diachi',isset($nhanvien)) ? $nhanvien['diachi'] : null }}">
                </div>
              </div>
              <div class="item form-group">
                <label for="password" class="control-label col-md-3">Số chứng minh thư </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" name="cmtnd" class="form-control col-md-7 col-xs-12" required="required" value="{{old('cmtnd',isset($nhanvien)) ? $nhanvien['cmtnd'] : null }}">
                </div>
              </div>
              <div class="item form-group">
                <label for="password" class="control-label col-md-3">Chức vụ</label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" name="chucvu" class="form-control col-md-7 col-xs-12" value="{{old('chucvu',isset($nhanvien)) ? $nhanvien['chucvu'] : null }}">
                </div>
              </div>
              <div class="item form-group">
                <label for="password2" class="control-label col-md-3 col-sm-3 col-xs-12">Ảnh đại diện</label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="file" name="anh" class="form-control col-md-7 col-xs-12" value="{{old('anh',isset($nhanvien)) ? $nhanvien['anh'] : null }}">
                </div>
              </div>
              <div class="item form-group">
