          ...
          <div class="x_content">
            ...
            <form class="form-horizontal form-label-left" novalidate action="" method="post" enctype="multipart/form-data">
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" name="tieude" class="form-control col-md-7 col-xs-12" required="required" value="{{old('tieude',isset($tailieuso)) ? $tailieuso['tieude'] : null }}">
                  <div style="color: red">
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" name="mota" class="form-control col-md-7 col-xs-12" required="required" value="{{old('mota',isset($tailieuso)) ? $tailieuso['mota'] : null }}">
                </div>
              </div>
